...
export const bookCompletions: BookCompletion[] = [
  ...
  {subject:'Matematik',book:'Fenomen 8-A Soru Bankası',completed:['Çarpanlar ve Katlar'],ongoing:['Üslü İfadeler']},
  {subject:'Matematik',book:'Fenomen 8-B Soru Bankası',completed:['Çarpanlar ve Katlar'],ongoing:['Üslü İfadeler']},
  ...
  {subject:'Matematik',book:'Nartest 36 Haftalık Deneme',completed:['Çarpanlar ve Katlar'],ongoing:['Üslü İfadeler']},
  ...
  {subject:'Fen Bilimleri',book:'MEB Örnek Sorular',completed:['Mevsimler ve İklim'],ongoing:['DNA ve Genetik Kod']},
  {subject:'Fen Bilimleri',book:'36 Haftalık Deneme',completed:['Mevsimler ve İklim'],ongoing:['DNA ve Genetik Kod']},
  {subject:'İnkılap',book:'Fenomen 8',completed:['Bir Kahraman Doğuyor','Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar']},
  {subject:'İnkılap',book:'Hız',completed:['Bir Kahraman Doğuyor'],ongoing:['Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar']},
  {subject:'İnkılap',book:'Nartest',completed:['Bir Kahraman Doğuyor'],ongoing:['Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar']},
  {subject:'İnkılap',book:'Paraf',completed:['Bir Kahraman Doğuyor'],ongoing:['Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar']},
  {subject:'Din Kültürü',book:'MEB Örnek Sorular',completed:['Kader İnancı'],ongoing:['Zekât ve Sadaka']},
  {subject:'Din Kültürü',book:'36 Haftalık Deneme',completed:['Kader İnancı'],ongoing:['Zekât ve Sadaka']},
  {subject:'İngilizce',book:'MEB Örnek Sorular',completed:['Friendship','Tourism'],ongoing:['Teen Life','Science']},
  {subject:'İngilizce',book:'36 Haftalık Deneme',completed:['Friendship'],ongoing:['Teen Life']},
];
